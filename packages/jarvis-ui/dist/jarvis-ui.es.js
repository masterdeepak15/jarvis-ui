...
import W, { useState as $, useEffect as U, useContext as xe, createContext as we, useCallback as E, useRef as L, useLayoutEffect as pa, useMemo as qe, Children as ma, isValidElement as ga, useId as Hn } from "react";
...
const Oe = {
  ...
  cardStyle: (e) => e ? ba[e] : "",
  buttonShape: (e) => e ? xa[e] : "",
  cls: (...e) => e.filter(Boolean).join(" ")
}, Gn = we(null);
function rl({ children: e, preset: t = "cyan", theme: n }) {
  const [r, a] = $(n ?? Tt[t]);
  U(() => {
    let c = document.getElementById("jarvis-theme-vars");
    c || (c = document.createElement("style"), c.id = "jarvis-theme-vars", document.head.appendChild(c)), c.textContent = va(r);
  }, [r]);
  const i = (c) => a(c), s = (c) => a(Tt[c]);
  return /* @__PURE__ */ o(Gn.Provider, { value: { theme: r, setTheme: i, setPreset: s }, children: e });
}
function ja() {
  const e = xe(Gn);
...
function al({ compact: e = !1, showCustom: t = !0 }) {
  const { theme: n, setPreset: r, setTheme: a } = ja(), [i, s] = $(!1), [c, l] = $(n.accent), [d, h] = $(n.bg), [u, f] = $(n.bgCard);
  function p(y, w) {
  ...
  return /* @__PURE__ */ g("div", { style: {
    ...
    /* @__PURE__ */ o("div", { style: { display: "flex", gap: "6px", flexWrap: "wrap" }, children: wa.map(({ preset: y, color: w, label: v }) => {
...
const ka = [
  ...
  "sq",
  "n"
], en = [12, 8, 14, 10, 6, 14, 16, 10, 12, 8, 16, 10], Sa = Array.from({ length: 20 }, (e, t) => ({
  h: 8 + (t * 7 + 3) % 11,
...
function Xe({
  ...
  return /* @__PURE__ */ g("div", { className: q.cls(
    ...
    a && /* @__PURE__ */ o("div", { className: "j-dot-seq", children: ka.map((f, p) => /* @__PURE__ */ o(
      "div",
      {
    ...
    i && /* @__PURE__ */ g(B, { children: [
      /* @__PURE__ */ o("div", { className: "j-waveform", style: { flex: 1, maxWidth: 260 }, children: Sa.map((f, p) => /* @__PURE__ */ o(
        "div",
        {
          className: "j-wv",
...
function ol({ href: e, icon: t, label: n, badge: r, active: a = !1, onClick: i }) {
  const s = {
    ...Na,
...
function cl({
  ...
  return /* @__PURE__ */ g(
    "div",
    {
      className: q.cls("j-hfc", $a[e], q.color(t)),
      style: { width: i, height: s },
      children: [
        e === "Alpha" && /* @__PURE__ */ o(Da, {}),
        e === "Beta" && /* @__PURE__ */ o(Ca, {}),
        e === "Gamma" && /* @__PURE__ */ o(Oa, {}),
        e === "Delta" && /* @__PURE__ */ o(Wa, {}),
...
const Ta = /* @__PURE__ */ new Set(["LeftNotch", "RightNotch", "BothNotch"]), _a = /* @__PURE__ */ new Set(["Parallelogram", "GhostSkew", "BracketFrame", "Hexagonal", "IconSquare", "ScanFull"]), Ia = {
...
function ll({
  ...
  const u = q.buttonShape(e), f = Ta.has(e), p = _a.has(e), x = f ? {
    clipPath: Ia[e],
...
function Ea({
  ...
  return e === "DoubleFrame" ? /* @__PURE__ */ g("div", { className: s, children: [
    ...
    /* @__PURE__ */ g("div", { className: "j-inner-frame", children: [
      n && /* @__PURE__ */ o("div", { style: nn, children: n }),
      i,
      r && /* @__PURE__ */ o("div", { style: rn, children: r })
    ] })
  ] }) : /* @__PURE__ */ g("div", { className: s, style: { padding: a }, children: [
    /* @__PURE__ */ o(Pa, { cardStyle: e }),
    n && /* @__PURE__ */ o("div", { style: nn, children: n }),
    /* @__PURE__ */ o("div", { style: { position: "relative", zIndex: 1 }, children: i }),
    r && /* @__PURE__ */ o("div", { style: rn, children: r })
  ] });
}
const Fa = { xs: 28, sm: 32, md: 38, lg: 44, xl: 50 }, Aa = { xs: 10, sm: 11, md: 12, lg: 13, xl: 14 };
function dl({
  type: e = "text",
  value: t,
  defaultValue: n,
...
const Ya = { xs: 10, sm: 11, md: 12, lg: 13, xl: 14 };
function ul({
  value: e,
  defaultValue: t,
  onChange: n,
...
const za = { xs: 28, sm: 32, md: 38, lg: 44, xl: 50 }, Ba = { xs: 10, sm: 11, md: 12, lg: 13, xl: 14 };
function fl({
  options: e,
  value: t,
  defaultValue: n,
...
function pl({ checked: e, onChange: t, label: n, value: r, name: a, disabled: i = !1 }) {
  return /* @__PURE__ */ g("label", { style: {
    display: "inline-flex",
    alignItems: "center",
    gap: 8,
...
function yl({ label: e, error: t, hint: n, required: r, children: a }) {
...
function ye(e, t) {
  try {
    ...
    return r in Re ? Re[r] : an(r, r.split(":"));
  } catch {
    if (e in Re) return Re[e];
    const n = e == null ? void 0 : e.match(Ha);
...
class fe extends Date {
  //#region static
  constructor(...t) {
    super(), t.length > 1 && typeof t[t.length - 1] == "string" && (this.timeZone = t.pop()), this.internal = /* @__PURE__ */ new Date(), isNaN(ye(this.timeZone, this)) ? this.setTime(NaN) : t.length ? typeof t[0] == "number" && (t.length === 1 || t.length === 2 && typeof t[1] != "number") ? this.setTime(t[0]) : typeof t[0] == "string" ? this.setTime(+new Date(t[0])) : t[0] instanceof Date ? this.setTime(+t[0]) : (this.setTime(+new Date(...t)), Ln(this, t)) : this.setTime(Date.now());
  }
  static tz(t, ...n) {
...
Object.getOwnPropertyNames(Date.prototype).forEach((e) => {
  ...
  fe.prototype[t] && (e.startsWith("get") ? fe.prototype[e] = function() {
    ...
    return Date.prototype[t].apply(this.internal, arguments), Ja(this), +this;
...
function Ja(e) {
  Date.prototype.setFullYear.call(e, e.internal.getUTCFullYear(), e.internal.getUTCMonth(), e.internal.getUTCDate()), Date.prototype.setHours.call(e, e.internal.getUTCHours(), e.internal.getUTCMinutes(), e.internal.getUTCSeconds(), e.internal.getUTCMilliseconds()), Ln(e);
}
function Ln(e, t) {
  const n = Array.isArray(t) ? Ga(t) : +e.internal, r = ye(e.timeZone, e), a = r > 0 ? Math.floor(r) : Math.ceil(r), i = /* @__PURE__ */ new Date(+e);
  ...
  const x = ye(e.timeZone, e), y = x > 0 ? Math.floor(x) : Math.ceil(x), v = -(/* @__PURE__ */ new Date(+e)).getTimezoneOffset() - y, b = y !== a, j = v - h, M = y - a, S = n - y * 60 * 1e3, m = M > 0 && sn(e) - n === M * 60 * 1e3 && sn(e, S) !== n;
  if (b && j && !m) {
...
class Q extends fe {
  ...
  toTimeString() {
    ...
    return `${t} GMT${n}${r}${a} (${Ra(this.timeZone, this)})`;
  }
  toLocaleString(t, n) {
...
const qn = 6048e5, La = 864e5, cn = Symbol.for("constructDateFrom");
function V(e, t) {
...
function At(e, t, n) {
  const [r, a] = Pe(
    ...
    e,
    t
  ), i = Ue(r), s = Ue(a), c = +i - ln(i), l = +s - ln(s);
  return Math.round((c - l) / La);
}
function Xa(e, t) {
  const n = Un(e, t), r = V(e, 0);
...
function eo(e) {
  return !(!Kn(e) && typeof e != "number" || isNaN(+z(e)));
}
function Qn(e, t, n) {
  const [r, a] = Pe(
    n == null ? void 0 : n.in,
...
function no(e, t) {
  const { start: n, end: r } = Zn(t == null ? void 0 : t.in, e);
  let a = +n > +r;
...
function Ye(e) {
  return (t, n = {}) => {
    ...
    if (!i)
      return null;
    const s = i[0], c = r && e.parsePatterns[r] || e.parsePatterns[e.defaultParseWidth], l = Array.isArray(c) ? No(c, (u) => u.test(s)) : (
...
const Do = /^(\d+)(th|st|nd|rd)?/i, Co = /\d+/i, Oo = {
  narrow: /^(b|a)/i,
...
function Yt(e, t) {
  const n = z(e, t == null ? void 0 : t.in), r = +Ve(n) - +Xa(n);
...
function Bo(e, t) {
  var c, l, d, h;
  const n = Ke(), r = (t == null ? void 0 : t.firstWeekContainsDate) ?? ((l = (c = t == null ? void 0 : t.locale) == null ? void 0 : c.options) == null ? void 0 : l.firstWeekContainsDate) ?? n.firstWeekContainsDate ?? ((h = (d = n.locale) == null ? void 0 : d.options) == null ? void 0 : h.firstWeekContainsDate) ?? 1, a = nr(e, t), i = V((t == null ? void 0 : t.in) || e, 0);
  return i.setFullYear(a, 0, r), i.setHours(0, 0, 0, 0), Ie(i, t);
}
function zt(e, t) {
  const n = z(e, t == null ? void 0 : t.in), r = +Ie(n, t) - +Bo(n, t);
  return Math.round(r / qn) + 1;
}
function Y(e, t) {
...
const hn = (e, t) => {
  ...
  return i.replace("{{date}}", hn(r, t)).replace("{{time}}", rr(a, t));
}, Ho = {
  p: rr,
  P: Ro
}, Jo = /^D+$/, Go = /^Y+$/, Lo = ["D", "DD", "YY", "YYYY"];
function qo(e) {
  return Jo.test(e);
}
function Xo(e) {
...
function Vo(e, t, n) {
  const r = Uo(e, t, n);
  if (console.warn(r), Lo.includes(e)) throw new RangeError(r);
}
function Uo(e, t, n) {
  const r = e[0] === "Y" ? "years" : "days of the month";
  return `Use \`${e.toLowerCase()}\` instead of \`${e}\` (in \`${t}\`) for formatting ${r} to the input \`${n}\`; see: https://github.com/date-fns/date-fns/blob/master/docs/unicodeTokens.md`;
}
const Ko = /[yYQqMLwIdDecihHKkms]o|(\w)\1*|''|'(''|[^'])+('|$)|./g, Qo = /P+p+|P+|p+|''|'(''|[^'])+('|$)|./g, Zo = /^'([^]*?)'?$/, ei = /''/g, ti = /[a-zA-Z]/;
function He(e, t, n) {
  var h, u, f, p, x, y, w, v;
  ...
  return l.map((b) => {
    ...
    const j = b.value;
    (!(n != null && n.useAdditionalWeekYearTokens) && Xo(j) || !(n != null && n.useAdditionalDayOfYearTokens) && qo(j)) && Vo(j, t, String(e));
    const M = dn[j[0]];
...
const pn = 5, fi = 4;
function hi(e, t) {
  const n = t.startOfMonth(e), r = n.getDay() > 0 ? n.getDay() : 7, a = t.addDays(e, -r + 1), i = t.addDays(a, pn * 7 - 1);
  return t.getMonth(e) === t.getMonth(i) ? pn : fi;
}
function ar(e, t) {
...
class re {
  ...
  constructor(t, n) {
    this.today = () => {
      ...
      var i;
      return (i = this.overrides) != null && i.addDays ? this.overrides.addDays(r, a) : Xn(r, a);
    }, this.addMonths = (r, a) => {
      var i;
      return (i = this.overrides) != null && i.addMonths ? this.overrides.addMonths(r, a) : Vn(r, a);
    }, this.addWeeks = (r, a) => {
      var i;
      return (i = this.overrides) != null && i.addWeeks ? this.overrides.addWeeks(r, a) : Va(r, a);
    }, this.addYears = (r, a) => {
      var i;
      return (i = this.overrides) != null && i.addYears ? this.overrides.addYears(r, a) : Ua(r, a);
    }, this.differenceInCalendarDays = (r, a) => {
      var i;
      return (i = this.overrides) != null && i.differenceInCalendarDays ? this.overrides.differenceInCalendarDays(r, a) : At(r, a);
    }, this.differenceInCalendarMonths = (r, a) => {
      var i;
      return (i = this.overrides) != null && i.differenceInCalendarMonths ? this.overrides.differenceInCalendarMonths(r, a) : Qn(r, a);
    }, this.eachMonthOfInterval = (r) => {
      var a;
      return (a = this.overrides) != null && a.eachMonthOfInterval ? this.overrides.eachMonthOfInterval(r) : no(r);
    }, this.eachYearOfInterval = (r) => {
      var c;
      const a = (c = this.overrides) != null && c.eachYearOfInterval ? this.overrides.eachYearOfInterval(r) : oo(r), i = new Set(a.map((l) => this.getYear(l)));
      if (i.size === a.length)
        return a;
      const s = [];
      return i.forEach((l) => {
      ...
      var a;
      return (a = this.overrides) != null && a.endOfBroadcastWeek ? this.overrides.endOfBroadcastWeek(r) : pi(r, this);
    }, this.endOfISOWeek = (r) => {
      var a;
      return (a = this.overrides) != null && a.endOfISOWeek ? this.overrides.endOfISOWeek(r) : io(r);
    }, this.endOfMonth = (r) => {
      var a;
      return (a = this.overrides) != null && a.endOfMonth ? this.overrides.endOfMonth(r) : to(r);
    }, this.endOfWeek = (r, a) => {
      var i;
      return (i = this.overrides) != null && i.endOfWeek ? this.overrides.endOfWeek(r, a) : tr(r, this.options);
    }, this.endOfYear = (r) => {
      var a;
      return (a = this.overrides) != null && a.endOfYear ? this.overrides.endOfYear(r) : ao(r);
    }, this.format = (r, a, i) => {
      var c;
      ...
      var i;
      return (i = this.overrides) != null && i.getMonth ? this.overrides.getMonth(r, this.options) : ai(r, this.options);
    }, this.getYear = (r, a) => {
      var i;
      return (i = this.overrides) != null && i.getYear ? this.overrides.getYear(r, this.options) : oi(r, this.options);
    }, this.getWeek = (r, a) => {
      var i;
      return (i = this.overrides) != null && i.getWeek ? this.overrides.getWeek(r, this.options) : zt(r, this.options);
    }, this.isAfter = (r, a) => {
      var i;
      return (i = this.overrides) != null && i.isAfter ? this.overrides.isAfter(r, a) : ii(r, a);
    }, this.isBefore = (r, a) => {
      var i;
      return (i = this.overrides) != null && i.isBefore ? this.overrides.isBefore(r, a) : si(r, a);
    }, this.isDate = (r) => {
      var a;
      return (a = this.overrides) != null && a.isDate ? this.overrides.isDate(r) : Kn(r);
    }, this.isSameDay = (r, a) => {
      var i;
      return (i = this.overrides) != null && i.isSameDay ? this.overrides.isSameDay(r, a) : Za(r, a);
    }, this.isSameMonth = (r, a) => {
      var i;
      return (i = this.overrides) != null && i.isSameMonth ? this.overrides.isSameMonth(r, a) : ci(r, a);
    }, this.isSameYear = (r, a) => {
      var i;
      return (i = this.overrides) != null && i.isSameYear ? this.overrides.isSameYear(r, a) : li(r, a);
    }, this.max = (r) => {
      var a;
      return (a = this.overrides) != null && a.max ? this.overrides.max(r) : Ka(r);
    }, this.min = (r) => {
      var a;
      return (a = this.overrides) != null && a.min ? this.overrides.min(r) : Qa(r);
    }, this.setMonth = (r, a) => {
      var i;
      return (i = this.overrides) != null && i.setMonth ? this.overrides.setMonth(r, a) : di(r, a);
    }, this.setYear = (r, a) => {
      var i;
      return (i = this.overrides) != null && i.setYear ? this.overrides.setYear(r, a) : ui(r, a);
    }, this.startOfBroadcastWeek = (r, a) => {
      var i;
      return (i = this.overrides) != null && i.startOfBroadcastWeek ? this.overrides.startOfBroadcastWeek(r, this) : ar(r, this);
    }, this.startOfDay = (r) => {
      var a;
      ...
      var a;
      return (a = this.overrides) != null && a.startOfMonth ? this.overrides.startOfMonth(r) : ro(r);
      ...
      var a;
      return (a = this.overrides) != null && a.startOfYear ? this.overrides.startOfYear(r) : er(r);
    }, this.options = { locale: or, ...t }, this.overrides = n;
  }
  /**
...
const ts = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  formatCaption: Xi,
  formatDay: Vi,
  formatMonthDropdown: Ui,
  formatWeekNumber: Qi,
  formatWeekNumberHeader: Zi,
...
function os(e, t) {
  ...
  return {
    ...as,
    ...e ?? {},
    labelDayButton: ie(dr, e == null ? void 0 : e.labelDayButton, n.labelDayButton),
    labelMonthDropdown: ie(hr, e == null ? void 0 : e.labelMonthDropdown, n.labelMonthDropdown),
    labelNext: ie(mr, e == null ? void 0 : e.labelNext, n.labelNext),
    labelPrevious: ie(gr, e == null ? void 0 : e.labelPrevious, n.labelPrevious),
    labelWeekNumber: ie(vr, e == null ? void 0 : e.labelWeekNumber, n.labelWeekNumber),
    labelYearDropdown: ie(xr, e == null ? void 0 : e.labelYearDropdown, n.labelYearDropdown),
    labelGrid: ie(ur, e == null ? void 0 : e.labelGrid, n.labelGrid),
    labelGridcell: ie(fr, e == null ? void 0 : e.labelGridcell, n.labelGridcell),
    labelNav: ie(pr, e == null ? void 0 : e.labelNav, n.labelNav),
    labelWeekNumberHeader: ie(br, e == null ? void 0 : e.labelWeekNumberHeader, n.labelWeekNumberHeader),
    labelWeekday: ie(yr, e == null ? void 0 : e.labelWeekday, n.labelWeekday)
  };
}
...
], us = (e) => Qe(e.querySelector("[data-animated-month]")), Mt = (e) => Qe(e.querySelector("[data-animated-caption]")), Dt = (e) => Qe(e.querySelector("[data-animated-weeks]")), fs = (e) => Qe(e.querySelector("[data-animated-nav]")), hs = (e) => Qe(e.querySelector("[data-animated-weekdays]"));
function ps(e, t, { classNames: n, months: r, focused: a, dateLib: i }) {
  ...
  pa(() => {
    ...
    if (y instanceof HTMLElement ? (Nt(y).forEach((j) => {
...
function vs(e, t, n, r) {
  const { addDays: a, endOfBroadcastWeek: i, endOfISOWeek: s, endOfMonth: c, endOfWeek: l, getISOWeek: d, getWeek: h, startOfBroadcastWeek: u, startOfISOWeek: f, startOfWeek: p } = r, x = e.reduce((y, w) => {
    ...
    const S = j.reduce((k, N) => {
      const C = n.ISOWeek ? d(N) : h(N), D = k.find((X) => X.weekNumber === C), T = new ir(N, w, r);
      return D ? D.days.push(T) : k.push(new gi(C, [T])), k;
    }, []), m = new mi(w, S);
    return y.push(m), y;
  }, []);
...
function ks(e, t) {
  var M;
  const [n, r] = bs(e, t), { startOfMonth: a, endOfMonth: i } = t, s = mn(e, n, r, t), [c, l] = vt(
    s,
  ...
  const { months: d, weeks: h, days: u, previousMonth: f, nextMonth: p } = qe(() => {
    const S = ys(c, r, { numberOfMonths: e.numberOfMonths }, t), m = ms(S, e.endMonth ? i(e.endMonth) : void 0, {
      ISOWeek: e.ISOWeek,
    ...
    }, t), N = ws(k), C = gs(k), D = js(c, n, e, t), T = xs(c, r, e, t);
    return {
      months: k,
      weeks: N,
      days: C,
...
function Ss(e, t, n, r) {
  ...
  for (const s of e) {
    const c = t(s);
    gn(c) && (c[J.focused] && i < de.FocusedModifier ? (a = s, i = de.FocusedModifier) : r != null && r.isEqualTo(s) && i < de.LastFocused ? (a = s, i = de.LastFocused) : n(s.date) && i < de.Selected ? (a = s, i = de.Selected) : c[J.today] && i < de.Today && (a = s, i = de.Today));
  }
  return a || (a = e.find((s) => gn(t(s)))), a;
}
function Ns(e, t, n, r, a, i, s) {
...
function jr(e, t, n, r, a, i, s, c = 0) {
  if (c > 365)
    return;
  const l = Ns(e, t, n.date, r, a, i, s), d = !!(i.disabled && be(l, i.disabled, s)), h = !!(i.hidden && be(l, i.hidden, s)), u = l, f = new ir(l, u, s);
  return !d && !h ? f : jr(e, t, f, r, a, i, s, c + 1);
}
function Ms(e, t, n, r, a) {
  const { autoFocus: i } = e, [s, c] = $(), l = Ss(t.days, n, r || (() => !1), s), [d, h] = $(i ? l : void 0);
  return {
    ...
    moveFocus: (y, w) => {
      if (!d)
        return;
      const v = jr(y, w, d, t.navStart, t.navEnd, e, a);
      v && (e.disableNavigation && !t.days.some((j) => j.isEqualTo(v)) || (t.goToDay(v), h(v)));
    }
  };
}
function Ds(e, t) {
  const { selected: n, required: r, onSelect: a } = e, [i, s] = vt(n, a ? n : void 0), c = a ? n : i, { isSameDay: l } = t, d = (p) => (c == null ? void 0 : c.some((x) => l(x, p))) ?? !1, { min: h, max: u } = e;
  return {
    selected: c,
    select: (p, x, y) => {
      let w = [...c ?? []];
...
function Cs(e, t, n = 0, r = 0, a = !1, i = he) {
...
function Ws(e, t, n = he) {
  const r = Array.isArray(t) ? t : [t];
  if (r.filter((c) => typeof c != "function").some((c) => typeof c == "boolean" ? c : n.isDate(c) ? ve(e, c, !1, n) : lr(c, n) ? c.some((l) => ve(e, l, !1, n)) : yt(c) ? c.from && c.to ? yn(e, { from: c.from, to: c.to }, n) : !1 : cr(c) ? Os(e, c.dayOfWeek, n) : Bt(c) ? n.isAfter(c.before, c.after) ? yn(e, {
  ...
  return {
    ...
    select: (p, x, y) => {
      ...
      if (p) {
        ...
        a && (S || !(h != null && h.from)) ? !s && m ? b = void 0 : b = { from: p, to: void 0 } : b = Cs(p, h, w, v, s, t);
      }
      return r && n && (b != null && b.from) && b.to && Ws({ from: b.from, to: b.to }, n, t) && (b.from = p, b.to = void 0), c || d(b), c == null || c(b, p, x, y), b;
    },
...
function _s(e, t) {
  const n = Ts(e, t), r = Ds(e, t), a = $s(e, t);
  switch (e.mode) {
    case "single":
      return n;
    case "multiple":
...
function wr(e) {
  ...
  if (n && (t = {
    ...
    Object.keys(t.modifiers).forEach((P) => {
      var I;
      _[P] = Ct((I = t.modifiers) == null ? void 0 : I[P], n);
    }), t.modifiers = _;
  }
  const { components: r, formatters: a, labels: i, dateLib: s, locale: c, classNames: l } = qe(() => {
    const _ = { ...or, ...t.locale }, P = t.broadcastCalendar ? 1 : t.weekStartsOn, I = t.noonSafe && t.timeZone ? ds(t.timeZone, {
      weekStartsOn: P,
      locale: _
  ...
  const { captionLayout: d, mode: h, navLayout: u, numberOfMonths: f = 1, onDayBlur: p, onDayClick: x, onDayFocus: y, onDayKeyDown: w, onDayMouseEnter: v, onDayMouseLeave: b, onNextClick: j, onPrevClick: M, showWeekNumber: S, styles: m } = t, { formatCaption: k, formatDay: N, formatMonthDropdown: C, formatWeekNumber: D, formatWeekNumberHeader: T, formatWeekdayName: X, formatYearDropdown: H } = a, R = ks(t, s), { days: Z, months: oe, navStart: ke, navEnd: Se, previousMonth: ee, nextMonth: K, goToMonth: te } = R, Ne = Hi(Z, t, ke, Se, s), { isSelected: pe, select: Ee, selected: et } = _s(t, s) ?? {}, { blur: qt, focused: tt, isFocusTarget: Br, moveFocus: Xt, setFocused: nt } = Ms(t, R, Ne, pe ?? (() => !1), s), { labelDayButton: Rr, labelGridcell: Hr, labelGrid: Jr, labelMonthDropdown: Gr, labelNav: Vt, labelPrevious: Lr, labelNext: qr, labelWeekday: Xr, labelWeekNumber: Vr, labelWeekNumberHeader: Ur, labelYearDropdown: Kr } = i, Qr = qe(() => cs(s, t.ISOWeek, t.broadcastCalendar, t.today), [s, t.ISOWeek, t.broadcastCalendar, t.today]), Ut = h !== void 0 || x !== void 0, bt = E(() => {
  ...
  return W.createElement(
    ...
    W.createElement(
      r.Root,
      { rootRef: t.animate ? Qt : void 0, className: sa, style: ca, dir: t.dir, id: t.id, lang: t.lang ?? c.code, nonce: t.nonce, title: t.title, role: t.role, "aria-label": t["aria-label"], "aria-labelledby": t["aria-labelledby"], ...la },
      W.createElement(
        r.Months,
        { className: l[O.Months], style: m == null ? void 0 : m[O.Months] },
        !t.hideNavigation && !u && W.createElement(r.Nav, { "data-animated-nav": t.animate ? "true" : void 0, className: l[O.Nav], style: m == null ? void 0 : m[O.Nav], "aria-label": Vt(), onPreviousClick: bt, onNextClick: xt, previousMonth: ee, nextMonth: K }),
        oe.map((_, P) => {
          ...
          return W.createElement(
            ...
            u === "around" && !t.hideNavigation && P === 0 && W.createElement(
              ...
              { type: "button", className: l[O.PreviousMonthButton], style: m == null ? void 0 : m[O.PreviousMonthButton], tabIndex: ee ? void 0 : -1, "aria-disabled": ee ? void 0 : !0, "aria-label": Lr(ee), onClick: bt, "data-animated-button": t.animate ? "true" : void 0 },
            ...
            W.createElement(r.MonthCaption, { "data-animated-caption": t.animate ? "true" : void 0, className: l[O.MonthCaption], style: m == null ? void 0 : m[O.MonthCaption], calendarMonth: _, displayIndex: P }, d != null && d.startsWith("dropdown") ? W.createElement(
              ...
              (() => {
                const G = d === "dropdown" || d === "dropdown-months" ? W.createElement(r.MonthsDropdown, { key: "month", className: l[O.MonthsDropdown], "aria-label": Gr(), disabled: !!t.disableNavigation, onChange: oa(_.date, I), options: is(_.date, ke, Se, a, s), style: Kt(O.MonthsDropdown), value: s.getMonth(_.date) }) : W.createElement("span", { key: "month" }, C(_.date, s)), A = d === "dropdown" || d === "dropdown-years" ? W.createElement(r.YearsDropdown, { key: "year", className: l[O.YearsDropdown], "aria-label": Kr(s.options), disabled: !!t.disableNavigation, onChange: ia(_.date, I), options: ls(ke, Se, a, s, !!t.reverseYears), style: Kt(O.YearsDropdown), value: s.getYear(_.date) }) : W.createElement("span", { key: "year" }, H(_.date, s));
            ...
            u === "around" && !t.hideNavigation && P === f - 1 && W.createElement(
              r.NextMonthButton,
              { type: "button", className: l[O.NextMonthButton], style: m == null ? void 0 : m[O.NextMonthButton], tabIndex: K ? void 0 : -1, "aria-disabled": K ? void 0 : !0, "aria-label": qr(K), onClick: xt, "data-animated-button": t.animate ? "true" : void 0 },
            ...
            P === f - 1 && u === "after" && !t.hideNavigation && W.createElement(r.Nav, { "data-animated-nav": t.animate ? "true" : void 0, className: l[O.Nav], style: m == null ? void 0 : m[O.Nav], "aria-label": Vt(), onPreviousClick: bt, onNextClick: xt, previousMonth: ee, nextMonth: K }),
            W.createElement(
              r.MonthGrid,
              { role: "grid", "aria-multiselectable": h === "multiple" || h === "range", "aria-label": Jr(_.date, s.options, s) || void 0, className: l[O.MonthGrid], style: m == null ? void 0 : m[O.MonthGrid] },
              !t.hideWeekdays && W.createElement(
                ...
                S && W.createElement(r.WeekNumberHeader, { "aria-label": Ur(s.options), className: l[O.WeekNumberHeader], style: m == null ? void 0 : m[O.WeekNumberHeader], scope: "col" }, T()),
                Qr.map((G) => W.createElement(r.Weekday, { "aria-label": Xr(G, s.options, s), className: l[O.Weekday], key: String(G), style: m == null ? void 0 : m[O.Weekday], scope: "col" }, X(G, s.options, s)))
              ),
              W.createElement(r.Weeks, { "data-animated-weeks": t.animate ? "true" : void 0, className: l[O.Weeks], style: m == null ? void 0 : m[O.Weeks] }, _.weeks.map((G) => W.createElement(
                ...
                S && W.createElement(r.WeekNumber, { week: G, style: m == null ? void 0 : m[O.WeekNumber], "aria-label": Vr(G.weekNumber, {
                  locale: c
                }), className: l[O.WeekNumber], scope: "row", role: "rowheader" }, D(G.weekNumber, s)),
                G.days.map((A) => {
                  const { date: ce } = A, F = Ne(A);
                  if (F[J.focused] = !F.hidden && !!(tt != null && tt.isEqualTo(A)), F[se.selected] = (pe == null ? void 0 : pe(ce)) || F.selected, yt(et)) {
                  ...
                  const ua = ss(F, m, t.modifiersStyles), fa = Ji(F, l, t.modifiersClassNames), ha = !Ut && !F.hidden ? Hr(ce, F, s.options, s) : void 0;
                  return W.createElement(r.Day, { key: `${A.isoDate}_${A.displayMonthId}`, day: A, modifiers: F, className: fa.join(" "), style: ua, role: "gridcell", "aria-selected": F.selected || void 0, "aria-label": ha, "data-day": A.isoDate, "data-month": A.outside ? A.dateMonthId : void 0, "data-selected": F.selected || void 0, "data-disabled": F.disabled || void 0, "data-hidden": F.hidden || void 0, "data-outside": A.outside || void 0, "data-focused": F.focused || void 0, "data-today": F.today || void 0 }, !F.hidden && Ut ? W.createElement(r.DayButton, { className: l[O.DayButton], style: m == null ? void 0 : m[O.DayButton], type: "button", day: A, modifiers: F, disabled: !F.focused && F.disabled || void 0, "aria-disabled": F.focused && F.disabled || void 0, tabIndex: Br(A) ? 0 : -1, "aria-label": Rr(ce, F, s.options, s), onClick: Zr(A, F), onBlur: ta(A, F), onFocus: ea(A, F), onKeyDown: na(A, F), onMouseEnter: ra(A, F), onMouseLeave: aa(A, F) }, N(ce, s.options, s)) : !F.hidden && N(A.date, s.options, s));
                })
              )))
            )
          );
    ...
    /* @__PURE__ */ g(
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ o("span", { children: Is(e) || n })
        ]
      }
    ),
...
function bl({
  ...
  const u = d.from ? `${bn(d.from)} — ${d.to ? bn(d.to) : "..."}` : n, f = {
    display: "inline-flex",
    alignItems: "center",
    gap: 8,
    height: 38,
...
function xl({
  ...
  const l = r === "12h" ? 12 : 23;
  function d(f) {
    const p = xn(parseInt(f || "0", 10), 0, l), x = jn(p);
    i(x), t == null || t(`${x}:${s || "00"}`);
  }
  function h(f) {
    const p = xn(parseInt(f || "0", 10), 0, 59), x = jn(p);
    c(x), t == null || t(`${a || "00"}:${x}`);
  }
  const u = {
    width: 44,
...
function kr({ color: e = "cyan", size: t = "sm", shape: n = "angular", blink: r = !1, showDot: a = !1, children: i }) {
  const s = {
    display: "inline-flex",
    alignItems: "center",
  ...
  return /* @__PURE__ */ g("span", { className: r ? "j-blink" : void 0, style: s, children: [
    a && /* @__PURE__ */ o(
      "span",
      {
        ...
        style: { marginRight: 5, display: "inline-block", flexShrink: 0, ...Es[e] ?? {} }
      }
    ),
    i
  ] });
...
function As({ state: e = "active", blink: t = !1, children: n }) {
  const { bg: r, accent: a } = Sn[e] ?? Sn.active;
  return /* @__PURE__ */ g(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ o("span", { className: "j-status-dot", style: Fs[e] }),
        /* @__PURE__ */ o("span", { style: { fontSize: 11, letterSpacing: "0.08em", color: a }, children: n })
      ]
    }
  );
}
const Nn = [12, 8, 14, 10, 6, 14, 16, 10, 12, 8, 16, 10], Ys = {
  warning: "var(--j-amber)",
  error: "var(--j-red)",
  success: "var(--j-green)"
}, zs = {
...
function Bs({
  ...
  if (r === "ticks") {
    const l = Math.round(e / 100 * s), d = Ys[n];
    return /* @__PURE__ */ g("div", { children: [
      ...
      /* @__PURE__ */ o("div", { className: "j-tick-row", children: Array.from({ length: s }, (h, u) => /* @__PURE__ */ o(
        "div",
        {
          ...
          style: { height: Nn[u % Nn.length], ...d ? { background: d } : {} }
        },
        u
      )) })
    ] });
  ...
  return /* @__PURE__ */ g("div", { children: [
    c,
    /* @__PURE__ */ o("div", { style: zs, children: a ? /* @__PURE__ */ g(B, { children: [
...
function jl({ orientation: e = "horizontal", label: t, showDot: n = !0, height: r = "40px", margin: a = "8px 0", opacity: i = 0.3 }) {
  ...
  return e === "vertical" ? /* @__PURE__ */ g("div", { style: { display: "flex", flexDirection: "column", alignItems: "center", height: r, margin: "0 8px" }, children: [
    ...
    n && /* @__PURE__ */ o("div", { style: { ...Mn, margin: "6px 0" } }),
    ...
    t ? /* @__PURE__ */ o("span", { style: { fontSize: 8, color: s, letterSpacing: "0.14em", textTransform: "uppercase", padding: "0 10px", opacity: 0.7, whiteSpace: "nowrap" }, children: t }) : n && /* @__PURE__ */ o("div", { style: { ...Mn, margin: "0 8px" } }),
    /* @__PURE__ */ o("div", { style: { flex: 1, height: 1, background: `linear-gradient(90deg, ${s}, transparent)`, opacity: i } })
  ] });
}
function wl({ variant: e = "chip", text: t, subText: n, value: r, color: a = "cyan", showDot: i = !0, showLine: s = !0 }) {
...
function kl({ state: e = "active", title: t, children: n, dismissible: r = !1, blink: a = !1, onDismiss: i }) {
  const [s, c] = $(!0);
  if (!s) return null;
  const l = Dn[e] ?? Dn.active, d = Cn[e] ?? Cn.active, h = Rs[e] ?? "ℹ", u = Hs[e];
  function f() {
    c(!1), i == null || i();
  }
  return /* @__PURE__ */ g(
...
function Ls({ label: e, value: t, barPercent: n, state: r = "active" }) {
  const a = Js[r], i = Gs[r];
...
function Sl({ open: e, onClose: t, title: n, subTitle: r, closable: a = !0, closeOnBackdrop: i = !0, width: s = "480px", notchSize: c = "18px", children: l, footer: d }) {
  if (!e) return null;
  const h = {
    position: "fixed",
    zIndex: 1001,
...
function Vs({ id: e, state: t, message: n, title: r, duration: a, onDismiss: i }) {
  const s = On[t] ?? On.active, c = qs[t] ?? "ℹ", l = Xs[t];
  return U(() => {
    if (a <= 0) return;
...
function Ml({ children: e }) {
  ...
  return /* @__PURE__ */ g(Sr.Provider, { value: { show: a, dismiss: i }, children: [
    e,
    /* @__PURE__ */ o("div", { style: { position: "fixed", bottom: 24, right: 24, zIndex: 2e3, display: "flex", flexDirection: "column-reverse", gap: 8, pointerEvents: "none", width: 320 }, children: t.map((s) => /* @__PURE__ */ o(Vs, { ...s, onDismiss: () => i(s.id) }, s.id)) })
  ] });
}
const Us = {
  warning: "j-text-warn",
...
function Dl({
  ...
  const p = q.cls("j-text-val", Us[s] ?? null), x = Ks[s];
  return /* @__PURE__ */ g(Ea, { cardStyle: e, color: t, padding: n, children: [
    /* @__PURE__ */ g("div", { style: { display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 4 }, children: [
      ...
      c && /* @__PURE__ */ o(kr, { color: l, size: "xs", children: c })
    ] }),
    ...
    h !== void 0 && /* @__PURE__ */ o("div", { style: { marginTop: 8 }, children: /* @__PURE__ */ o(Bs, { value: h, variant: "bar", showPercent: !1 }) }),
    u && u.length > 0 && /* @__PURE__ */ o("div", { style: { marginTop: 8 }, children: u.map((y) => /* @__PURE__ */ o(Ls, { label: y.label, value: y.value, barPercent: y.barPercent }, y.label)) }),
    f
  ] });
}
const Nr = we(null);
...
function Cl({ activeTab: e, onTabChange: t, children: n }) {
  var h;
  const r = [];
  ma.forEach(n, (u) => {
    if (ga(u) && u.type._isJTab) {
      const f = u.props;
  ...
  return /* @__PURE__ */ g(Nr.Provider, { value: { activeTab: c, selectTab: l }, children: [
    /* @__PURE__ */ o(
      "div",
      {
        role: "tablist",
...
function Zs({ tabKey: e, children: t }) {
  const n = Qs();
...
function Ol({
  ...
  const [d, h] = $(r), u = Hn(), f = a !== void 0 ? a : d, p = ec(s, c);
  function x() {
    const y = !f;
    ...
    "nav",
    {
      ...
      children: [
        ...
        n <= 10 ? (
          ...
          /* Ellipsis mode */
          /* @__PURE__ */ o(B, { children: tc(e, n, i).map(
            (d, h) => d === -1 ? /* @__PURE__ */ o(
              "span",
              {
...
const Wn = [6, 10, 14, 14, 10, 6, 8, 12, 16, 16, 12, 8];
function $l({
  level: e,
  totalArcs: t = 6,
  color: n = "cyan",
  ...
  const d = r === "vertical";
  function h(f) {
    const p = f < e, x = f === e - 1 && e > 0, y = Wn[f % Wn.length], w = d ? { width: y, height: 4 } : { width: c, height: y };
    let v, b, j;
...
const $n = [6, 14, 22, 18, 28, 20, 30, 24, 28, 22, 16, 20, 26, 18, 12, 22, 28, 18, 10, 14], Tn = [".4s", ".5s", ".6s", ".4s", ".7s", ".5s", ".6s", ".4s", ".8s", ".5s"];
function Tl({
  barCount: e = 20,
  height: t = "32px",
  active: n = !0
  ...
  return /* @__PURE__ */ o(
    "div",
    {
      ...
      children: Array.from({ length: e }, (r, a) => {
        const i = {
          height: `${$n[a % $n.length]}px`,
          background: "var(--j-accent)",
          "--j-wv-dur": Tn[a % Tn.length],
...
const oc = Array.from({ length: 12 }, (e, t) => t * 30);
function _l({
  systemName: e = "JARVIS",
  size: t = "160px",
  state: n = "active",
...
const ic = 80, sc = 28, Dr = 2, Jt = 3, cc = ic - Dr * 2, _t = sc - Jt * 2, _n = Jt + _t;
function lc(e) {
  if (e.length === 0) return [];
  const t = Math.min(...e), n = Math.max(...e), r = n - t === 0 ? 1 : n - t;
  return e.map((a, i) => ({
    x: Dr + i * (cc / Math.max(e.length - 1, 1)),
    y: Jt + _t - _t * (a - t) / r
  }));
}
function dc(e, t) {
...
function Il({
  ...
  const c = lc(e), l = dc(e, i), h = `var(${s ?? (l === "up" ? "--j-ok" : l === "down" ? "--j-err" : "--j-accent")})`, u = c.map((w) => `${w.x.toFixed(1)},${w.y.toFixed(1)}`).join(" "), f = l === "up" ? "▲" : l === "down" ? "▼" : "─", p = l === "up" ? "j-text-ok" : l === "down" ? "j-text-err" : "j-text-accent";
  let x = "";
  if (c.length >= 2) {
    x = `M ${c[0].x.toFixed(1)} ${_n} L ${c[0].x.toFixed(1)} ${c[0].y.toFixed(1)}`;
    for (let w = 1; w < c.length; w++)
      x += ` L ${c[w].x.toFixed(1)} ${c[w].y.toFixed(1)}`;
    x += ` L ${c[c.length - 1].x.toFixed(1)} ${_n} Z`;
  }
...
const It = 400, Je = 220, me = 36, Cr = 8, Ge = 12, Or = 22, ot = 6, it = It - me - Cr, st = Je - Ge - Or;
function ct(e) {
...
const Pt = 400, Et = 200, ft = 36, Wr = 8, Le = 10, uc = 20, fc = Pt - ft - Wr, ze = Et - Le - uc;
function hc(e) {
  return e >= 1e6 ? `${(e / 1e6).toFixed(1)}M` : e >= 1e3 ? `${(e / 1e3).toFixed(1)}K` : e.toFixed(1);
}
function El({
  ...
  const l = e.map((w) => w.value), d = Math.min(...l), h = Math.max(...l), u = h - d === 0 ? 1 : h - d, f = `var(${n})`, p = e.map((w, v) => ({
    x: ft + v * (fc / Math.max(e.length - 1, 1)),
...
function Al({
  ...
  const f = Math.max(0, Math.min(1, (e - t) / (n - t || 1))), p = `var(${a})`, x = dt * f, y = mt(lt + f * dt), w = ge + (ue - 2) * Math.cos(y), v = Ce + (ue - 2) * Math.sin(y), b = ue - i / 2 - 2, j = ue + i / 2 + 4;
...
const $r = 100, Tr = 100, Be = 78;
function pc(e) {
  return e * Math.PI / 180;
}
function mc(e, t) {
  return pc(360 * e / t - 90);
}
function ht(e, t, n) {
  const r = mc(e, t);
  return [$r + n * Math.cos(r), Tr + n * Math.sin(r)];
}
function Pn(e, t, n) {
  const [r, a] = ht(e, t, n);
...
function Yl({
  ...
  const i = Math.max(e.length, 3), s = `var(${n},var(--j-accent))`, c = Array.from({ length: r }, (f, p) => {
    const x = Be * (p + 1) / r, y = Array.from({ length: i }, (w, v) => Pn(v, i, x)).join(" ");
    ...
    const x = En(f.value / ((f.max ?? 100) || 1));
    return Pn(p, i, Be * x);
  }).join(" "), h = e.map((f, p) => {
    const x = En(f.value / ((f.max ?? 100) || 1)), [y, w] = ht(p, i, Be * x);
    return /* @__PURE__ */ o(
      "circle",
      {
        cx: y,
    ...
    const [x, y] = ht(p, i, Be + 14), w = x < 98 ? "end" : x > 102 ? "start" : "middle";
    return /* @__PURE__ */ o(
      "text",
      {
        x,
  ...
  return /* @__PURE__ */ g(
    "div",
    {
      ...
      children: [
        ...
        i >= 2 && /* @__PURE__ */ o("div", { style: { position: "absolute", top: "30%", left: "10%", right: "10%" }, children: Fn.slice(0, d).map((f, p) => /* @__PURE__ */ o(
          "div",
          {
            "data-boot-line": "",
            style: {
  ...
  return /* @__PURE__ */ g("div", { style: {
    ...
    /* @__PURE__ */ o("div", { style: { overflowX: "auto" }, children: /* @__PURE__ */ g("table", { style: { width: "100%", borderCollapse: "collapse", fontSize: 11, fontFamily: "'Courier New', monospace" }, children: [
      ...
      /* @__PURE__ */ o("tbody", { children: c ? /* @__PURE__ */ o("tr", { children: /* @__PURE__ */ o("td", { colSpan: e.length, style: { padding: 24 }, children: /* @__PURE__ */ g("div", { style: { display: "flex", alignItems: "center", justifyContent: "center", gap: 10 }, children: [
        ...
        const h = bc(l, n), u = d === i, f = u ? "var(--j-accent-05)" : d % 2 === 0 ? "transparent" : "var(--j-accent-05)", p = yc[h] ?? "transparent";
        return /* @__PURE__ */ o(
          "tr",
          {
            "data-state": h,
            ...
            onMouseLeave: () => s(-1),
            children: e.map((y) => {
              const w = String(l[y.key] ?? ""), v = gc[h] ?? "var(--j-text-secondary)", b = {
                padding: "8px 14px",
              ...
              let j = w;
              return y.key === n ? j = /* @__PURE__ */ o(As, { state: h, children: w }) : y.isBadge && (j = /* @__PURE__ */ o(kr, { color: vc[h] ?? "cyan", children: w })), /* @__PURE__ */ o("td", { style: b, children: j }, y.key);
            })
          },
          d
        );
  ...
  return /* @__PURE__ */ g(B, { children: [
    ...
    /* @__PURE__ */ g("div", { style: {
      ...
      /* @__PURE__ */ o("div", { style: { maxHeight: 360, overflowY: "auto" }, children: u.length === 0 ? /* @__PURE__ */ o("div", { style: {
        ...
        const N = m === l, C = xc(S.state ?? "active");
        return /* @__PURE__ */ g("div", { children: [
...
function Hl({
  ...
  return /* @__PURE__ */ g(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ o(_r.Provider, { value: x, children: i }),
        s.map((v) => {
          const { x: b, y: j } = Nc(v.angle, r), M = h === v.key, S = wc(v.state), m = kc(v.state), k = Sc(v.state), N = l ? `translate(calc(-50% + ${b}px), calc(-50% + ${j}px))` : "translate(-50%, -50%)";
          return /* @__PURE__ */ g(
            "div",
            {
              "data-item-key": v.key,
...
function Gl({
  ...
  const [h, u] = $({ x: t, y: n }), [f, p] = $(!1), [x, y] = $(!1), w = L(null), v = L(null), b = Mc[a] ?? "var(--j-accent)", j = E((m) => {
...
function ql({
  ...
  const c = An[n] ?? An.cyan, l = t / 2, d = t / 2, h = Math.max(0, Math.min(100, e)) / 100, u = t * 0.46, f = t * 0.34, p = t * 0.22, x = t * 0.1, y = 2 * Math.PI * f, w = y * h, v = y * (1 - h), b = [0, 120, 240].map((S) => {
  ...
  return /* @__PURE__ */ g("div", { className: s, style: { fontFamily: "'Courier New', monospace", ...c }, children: [
    /* @__PURE__ */ o(
      "div",
      {
        ...
        children: e.map((f) => {
          const p = Cc[f.level ?? "info"], x = Oc[f.level ?? "info"];
          return /* @__PURE__ */ g(
            "div",
            {
              style: {
...
function Ul({
  ...
  const c = L(null), l = zn[n] ?? zn.cyan, d = `ticker-${n}-${e.length}`;
  U(() => {
    const f = c.current;
    if (!f) return;
  ...
  return /* @__PURE__ */ g(
    "div",
    {
      ...
      children: [
        ...
        e.map((m) => {
          const k = d[m.id] ?? { x: m.x, y: m.y }, N = Wc[m.color ?? "cyan"] ?? "var(--j-accent)", C = u[m.id], D = y.indexOf(m.id);
          return /* @__PURE__ */ g(
            "div",
            {
              style: {
...
function Ql({
  ...
  const c = `ng${Hn().replace(/:/g, "")}`, [l, d] = $({}), [h, u] = $(null), f = L(null);
  U(() => {
    d((v) => {
      const b = { ...v };
      return e.forEach((j) => {
        b[j.id] || (b[j.id] = { x: j.x, y: j.y, w: $c(j), h: Tc(j) });
      ...
      children: [
        ...
        /* @__PURE__ */ g("svg", { style: { position: "absolute", inset: 0, width: "100%", height: "100%", pointerEvents: "none", zIndex: 1, overflow: "visible" }, children: [
          ...
          t.map((v) => {
            ...
            if (!b || !j) return null;
            const [M, S] = w(b, j, v.from, !0), [m, k] = w(j, b, v.to, !1), N = M + (m - M) * 0.5, C = S, D = m - (m - M) * 0.5, T = k, X = `M ${le(M)} ${le(S)} C ${le(N)} ${le(C)} ${le(D)} ${le(T)} ${le(m)} ${le(k)}`, H = _c(v.color), R = `ep-${c}-${v.from}-${v.to}`, Z = v.arrow ?? !0 ? `url(#${c}-${Ic(v.color)})` : "none", oe = v.style === "dashed" ? "6,4" : v.style === "dotted" ? "2,4" : void 0;
        ...
        e.map((v) => {
          const b = l[v.id];
          if (!b) return null;
          const j = Ir(v.color), M = h === v.id, S = v.type ?? "chip";
          return /* @__PURE__ */ g(
            "div",
            {
              "data-node-id": v.id,
...
const Pr = we("windows11");
function Gt() {
  return xe(Pr);
}
function Pc({ theme: e, children: t }) {
  return /* @__PURE__ */ o(Pr.Provider, { value: e, children: /* @__PURE__ */ o("div", { "data-os-theme": e, "data-testid": "j-os-root", className: "j-os-root", children: t }) });
}
const Er = we(null);
function Ze() {
  const e = xe(Er);
...
function Yc({ compactBreakpoint: e = 900, children: t }) {
  const [n, r] = $([]), a = L([]), [i, s] = $(null), [c, l] = $({ w: 0, h: 0 }), d = L({ w: 0, h: 0 }), h = c.w > 0 && c.w < e, u = E((m) => {
    ...
    d.current = { w: m, h: k }, l({ w: m, h: k }), u((N) => N.map((C) => ({
      ...C,
      ...ut(C.x, C.y, C.width, C.height, m, k)
    })));
  }, [u]), p = E((m) => {
    const k = a.current.find((C) => C.appId === m.appId);
    if (k)
      return s(k.id), u((C) => C.map(
        (D) => D.id === k.id ? { ...D, minimized: !1, zIndex: Date.now() } : D
      )), k.id;
    const N = Fc();
    return u((C) => {
      const { x: D, y: T } = Ac(C, d.current.w, d.current.h), X = m.width ?? 640, H = m.height ?? 420, R = ut(D, T, X, H, d.current.w, d.current.h), Z = {
        id: N,
        appId: m.appId,
        title: m.title,
        icon: m.icon,
    ...
    u((k) => k.map((N) => N.id === m ? { ...N, minimized: !1, zIndex: Date.now() } : N)), s(m);
  }, [u]), v = E((m) => {
    u((k) => k.map((N) => N.id === m ? { ...N, maximized: !N.maximized } : N));
  }, [u]), b = E((m) => {
    s(m), u((k) => k.map((N) => N.id === m ? { ...N, zIndex: Date.now() } : N));
  }, [u]), j = E((m, k, N) => {
    u((C) => C.map((D) => {
      if (D.id !== m) return D;
      const T = ut(k, N, D.width, D.height, d.current.w, d.current.h);
      return { ...D, ...T };
    }));
  }, [u]), M = E((m, k, N) => {
    u((C) => C.map((D) => {
      if (D.id !== m) return D;
      const T = ut(D.x, D.y, k, N, d.current.w, d.current.h);
      return { ...D, ...T };
    }));
  }, [u]), S = {
    windows: n,
  ...
  return /* @__PURE__ */ o(Er.Provider, { value: S, children: t });
}
const zc = ["n", "s", "e", "w", "nw", "ne", "sw", "se"];
function Bc({ id: e }) {
  const { windows: t, focusedId: n, compactMode: r, focusWindow: a, closeWindow: i, minimizeWindow: s, maximizeWindow: c, moveWindow: l, resizeWindow: d } = Ze(), h = Gt(), u = L(null), f = t.find((D) => D.id === e);
  ...
  return /* @__PURE__ */ g(
    "div",
    {
      ...
      onPointerDown: () => a(e),
      children: [
        !r && !p.maximized && zc.map((D) => /* @__PURE__ */ o(
          "div",
          {
...
function ed({ children: e }) {
  const t = L(1), [n, r] = $([]), [a, i] = $([]), s = L([]), [c, l] = $([]), d = Gt(), h = E((y) => {
    i((w) => {
      const v = y(w);
  ...
  U(() => {
    if (n.length > 0 && a.length < $t) {
      const y = Math.min(n.length, $t - a.length);
  ...
  const p = E((y) => {
    ...
    s.current.length < $t ? (s.current = [...s.current, v], i((M) => [...M, v])) : r((M) => [...M, v]);
  ...
  return /* @__PURE__ */ g(Lt.Provider, { value: { notify: p, recent: c, clearAll: f }, children: [
    e,
    Jn(x, document.body)
  ] });
}
function Jc({ apps: e, onClose: t }) {
...
function Lc({ onClose: e }) {
  const t = Rc(), n = Fr(), r = Gc(), a = (t == null ? void 0 : t.recent) ?? [], i = (t == null ? void 0 : t.clearAll) ?? (() => {
  }), [s, c] = $(
    Object.fromEntries(Bn.map((l) => [l.id, l.defaultOn]))
  );
  return /* @__PURE__ */ g(
    "div",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ o("div", { className: "j-os-notif-center__qs", children: Bn.map((l) => /* @__PURE__ */ g(
          "button",
          {
...
function qc({ apps: e }) {
  const { windows: t, focusWindow: n, restoreWindow: r } = Ze(), [a, i] = $(!1), [s, c] = $(!1), l = Fr();
  function d(f) {
  ...
  return /* @__PURE__ */ g(B, { children: [
    a && /* @__PURE__ */ o(Jc, { apps: e, onClose: () => i(!1) }),
    s && /* @__PURE__ */ o(Lc, { onClose: () => c(!1) }),
    /* @__PURE__ */ g(
      "div",
      {
...
function Uc({ apps: e, wallpaper: t, initialWindows: n }) {
  const { windows: r, openWindow: a, setDesktopSize: i } = Ze(), s = Gt(), c = L(null), l = s === "windows11";
  U(() => {
    const u = c.current;
    if (!u) return;
  ...
  return /* @__PURE__ */ g("div", { ref: c, className: "j-os-desktop", style: {
    ...
    !l && /* @__PURE__ */ o(Vc, { appName: "Desktop" }),
    /* @__PURE__ */ o(
      "div",
      {
    ...
    r.filter((u) => !u.minimized).map((u) => /* @__PURE__ */ o(Bc, { id: u.id }, u.id)),
    l ? /* @__PURE__ */ o(qc, { apps: e }) : /* @__PURE__ */ o(Xc, { apps: e })
  ] });
}
function td({
  theme: e,
  ...
  return /* @__PURE__ */ o(Pc, { theme: e, children: /* @__PURE__ */ o(Yc, { compactBreakpoint: r, children: /* @__PURE__ */ o(Uc, { apps: t, wallpaper: n, initialWindows: a }) }) });
}
function Ar(e) {
  return e.icon ? e.icon : e.type === "folder" ? "📁" : "📄";
}
function Yr({ node: e, depth: t, expanded: n, selected: r, onExpand: a, onSelect: i }) {
...
function nd({ tree: e, onOpen: t, onSelect: n, initialPath: r }) {
  ...
  const x = s ? zr(e, s) : null, y = ((x == null ? void 0 : x.children) ?? []).filter((b) => b.type === "file"), w = s ? Kc(e, s) : [], v = "Home" + (w.length > 0 ? " / " + w.map((b) => b.name).join(" / ") : "");
    ...
    /* @__PURE__ */ g("div", { className: "j-os-fileexplorer__body", children: [
      ...
      /* @__PURE__ */ o("div", { className: "j-os-fileexplorer__pane", children: y.map((b) => /* @__PURE__ */ g(
        "div",
        {
          ...
          onDoubleClick: () => p(b),
          children: [
            /* @__PURE__ */ o("span", { className: "j-os-pane-item__icon", children: Ar(b) }),
...
function rd({ processes: e, onKill: t }) {
  ...
  return /* @__PURE__ */ o("div", { className: "j-os-taskmanager", children: /* @__PURE__ */ o("div", { style: { flex: 1, overflow: "auto" }, children: /* @__PURE__ */ g("table", { className: "j-os-taskmanager__table", children: [
    ...
    /* @__PURE__ */ o("tbody", { children: c.map((d) => /* @__PURE__ */ g("tr", { children: [
      ...
      /* @__PURE__ */ o("td", { children: /* @__PURE__ */ o(Rn, { value: d.cpu, label: `${d.cpu}%` }) }),
      /* @__PURE__ */ o("td", { children: /* @__PURE__ */ o(Rn, { value: d.memory / 2048 * 100, label: `${d.memory} MB` }) }),
      /* @__PURE__ */ o("td", { children: /* @__PURE__ */ o(Zc, { status: d.status }) }),
      t && /* @__PURE__ */ o("td", { children: /* @__PURE__ */ o("button", { className: "j-os-tm-kill", onClick: () => t(d.pid), children: "Kill" }) })
    ] }, d.pid)) })
  ] }) }) });
}
function ad({ sections: e, defaultSection: t }) {
...
export {
  ...
  Ea as JCard,
  hl as JCheckbox,
  Rl as JCommandPalette,
  ad as JControlPanel,
  Ls as JDataRow,
  vl as JDatePicker,
  bl as JDateRangePicker,
  td as JDesktop,
  jl as JDivider,
  Xc as JDock,
  Fl as JDonutChart,
  ...
  ol as JNavItem,
  Ql as JNodeGraph,
  ed as JOSNotificationProvider,
  Pc as JOSThemeProvider,
  _l as JOrb,
  il as JPageLayout,
  Wl as JPagination,
  Bs as JProgress,
  ...
  ul as JTextArea,
  al as JThemePicker,
  rl as JThemeProvider,
  xl as JTimePicker,
  Ml as JToastProvider,
  ml as JToggle,
  Tl as JWaveform,
  Bc as JWindow,
  Yc as JWindowManager,
  q as JarvisTokens,
  Tt as PRESETS,
  _r as RadialMenuContext,
  va as toCss,
  Zl as useOSNotify,
  Rc as useOSNotifyOptional,
  Gt as useOSTheme,
  jc as useRadialMenu,
  ja as useTheme,
  Nl as useToast,
