...
export const PRESETS: Record<JThemePreset, JarvisTheme> = {
  ...
  amber:  { name: 'Amber',  preset: 'amber',  ...BASE,
    ...
    textPrimary: '#fff7ed', textSecondary: '#ffe0bc', textMuted: '#c49060', textDim: '#7a5030',
  },
  green:  { name: 'Green',  preset: 'green',  ...BASE,
    ...
    textPrimary: '#f0fdf4', textSecondary: '#c0f0cc', textMuted: '#70b080', textDim: '#3a6040',
  },
  red:    { name: 'Red',    preset: 'red',    ...BASE,
    ...
    textPrimary: '#fff1f2', textSecondary: '#ffd0cc', textMuted: '#c07068', textDim: '#703030',
  },
  purple: { name: 'Purple', preset: 'purple', ...BASE,
    ...
    textPrimary: '#faf5ff', textSecondary: '#e0c8ff', textMuted: '#9870c0', textDim: '#504070',
  },
